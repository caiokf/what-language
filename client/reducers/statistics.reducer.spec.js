...
describe('statistics reducer', () => {
  ...
  describe('calculating statistics', () => {
    it('how many countries a person can communicate in', () => {
      const result = reducer(initialState, { type: 'CALCULATE_STATISTICS', payload: { languages: ['en']} });
    ...
    it('should not count countries twice', () => {
      const result = reducer(initialState, { type: 'CALCULATE_STATISTICS', payload: { languages: ['en', 'fr']} });
    ...
    it('should count unofficial languages', () => {
      const result = reducer(initialState, { type: 'CALCULATE_STATISTICS', payload: {
        languages: ['zh'],
        options: { unofficial: true }
      }});
    ...
    it('should not count official and unofficial languages twice', () => {
      const result = reducer(initialState, { type: 'CALCULATE_STATISTICS', payload: { languages: ['en', 'zh']} });
    ...
    it('should not fail when there is no unofficialLanguages', () => {
      ...
      const result = reducer(state, { type: 'CALCULATE_STATISTICS', payload: { languages: ['en', 'zh']} });
  ...
  describe('map properties', () => {
    ...
    it('should not mark unofficial languages when option is false', () => {
      const result = reducer(initialState, { type: 'CALCULATE_STATISTICS', payload: {
        languages: ['zh'],
        options: { unofficial: false }
      }});

      expect(result.toJS().mapData['GBR'].fillKey).to.equal('defaultFill');
    });
  });
});
