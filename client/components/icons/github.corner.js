...
export default class GithubCorner extends React.Component {
  render() {
    return (
      <a href="https://github.com/caiokf/what-language/" target="_blank" rel="noopener noreferrer" className="github-corner">
        <svg height="80" width="80" id="github" viewBox="0 0 250 250" className="github-icon">
          <g>
